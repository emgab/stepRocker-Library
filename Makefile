...
# Paths to Samsung libraries
SAMSUNG_LIB_DIR = ./lib/
SAMSUNG_CSP_DIR = $(SAMSUNG_LIB_DIR)
SAMSUNG_CSP_SRC_DIR = $(SAMSUNG_CSP_DIR)/src
SAMSUNG_CSP_INC_DIR = $(SAMSUNG_CSP_DIR)/inc
INCLUDE_DIRS = -I./lib
...
## Our Application:
SRC = stepRocker.c SysTick.c RS485.c Commands.c Globals.c \
      TMC429.c SPI.c TMC262.c IO.c SysControl.c Eeprom.c


## used parts of the Samsung Library
SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_adc.c
SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_can.c
SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_cm.c
SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_dma.c
SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_enc.c
SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_frt.c
SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_i2c.c
SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_ifc.c
SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_imc.c
SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_ioconf.c
SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_lcd.c
SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_nvic.c
SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_pseudo_intrinsics.c
SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_pwm.c
#SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_pwm_b.c
SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_ssp.c
SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_stt.c
SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_systick.c
SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_tc16.c
SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_tc32.c
SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_usart.c
SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_usb.c
SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_wdt.c
SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_gpio.c
SRC += $(SAMSUNG_CSP_SRC_DIR)/csp_vector.c
...
EXTRAINCDIRS  = $(SAMSUNG_CSP_INC_DIR)
...
ifeq ($(BOOT_LOADER),TMCM-BL)
LDFLAGS +=-T $(LINKERSCRIPTPATH)/s3fn41f-tmcm.ld
else
LDFLAGS +=-T $(LINKERSCRIPTPATH)/s3fn41f.ld
endif
#endif
